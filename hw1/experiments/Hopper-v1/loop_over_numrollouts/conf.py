...
TRAIN_DATA = '/'.join(str.split(current_dir, '/')[:-3]) + '/training_data/Hopper-v1/trainingdata_100rollouts.pkl'
TEST_DATA = '/'.join(str.split(current_dir, '/')[:-3]) + '/training_data/Hopper-v1/testdata_10rollouts.pkl'
...
'maxsteps':False,
'pretrained_model':current_dir + '/modeldata/model95002'
}
