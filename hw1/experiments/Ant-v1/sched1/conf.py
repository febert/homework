...
TRAIN_DATA = '/'.join(str.split(current_dir, '/')[:-3]) + '/training_data/Ant-v1/trainingdata_100rollouts.pkl'
TEST_DATA = '/'.join(str.split(current_dir, '/')[:-3]) + '/training_data/Ant-v1/testdata_10rollouts.pkl'
